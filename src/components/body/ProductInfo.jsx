...
const ProductInfo = () => {
  ...
  return (
    <div className=" pt-10 lg:pt-6">
      <div className="max-w-6xl px-4 mx-auto my-3 lg:my-5 transition-all ">
            ...
            <div className="lg:pl-20">
              ...
              <div className="flex flex-wrap gap-2 items-center mb-6">
                {cartItems.some((p) => p.uid === product.uid) // Ensure comparison is correct
                  ? <button className="w-full bg-yellow-500 text-white py-2 px-4 rounded-full hover:bg-yellow-600 focus:outline-none" onClick={() => deleteCart(product)}>Delete From Cart</button>
                  : <button className="w-full bg-blue-500 text-white py-2 px-4 rounded-full hover:bg-blue-600 focus:outline-none" onClick={() => addCart(product)}>Add to Cart</button>
                }
                <button className="w-full bg-green-700 text-white py-2 px-4 rounded-full hover:bg-green-800 focus:outline-none" onClick={seeOwnerDetails}>Owner details</button>
                {ownerDetails &&
                  <div className="w-full text-sm text-gray-700  p-4  bg-green-100 rounded-full px-6">
