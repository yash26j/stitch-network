...
function Signup() {
    ...
    return (
        <div className=' flex justify-center items-center h-screen'>
            <div className=' bg-orange-100 shadow-xl hover:shadow-2xl px-10 py-10 rounded-xl '>
                <div className="">
                ...
                <div className=' flex justify-center mb-3 flex-col gap-2'>
                    <button
                        className=' bg-orange-500 w-full text-gray-50 font-bold  px-2 py-2 rounded-lg'
                ...
                <div>
                    <h2 className='text-black'>Already have an account <Link className=' text-orange-500 font-bold' to={'/login'}>Login</Link></h2>
                </div>
            </div>
        </div>
    )
